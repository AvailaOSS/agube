from login.views import UserAddressUpdateDeleteView, UserCreateAddressView, UserCustomDetailListView, UserDwellingDetailView, UserCreatePhoneView, UserUpdateDeletePhoneView
...
__url_user = [
    ...
    path('/<int:pk>/address/<int:full_address_id>', UserAddressUpdateDeleteView.as_view()),
