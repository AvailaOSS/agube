...
export class MeasurementService {
   ...
   * @param id A unique integer value identifying this water meter measurement.
   * @param data
  ...
  public updateMeasurement(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling updateMeasurement.'
      );
    }

    if (data === null || data === undefined) {
      throw new Error(
        'Required parameter data was null or undefined when calling updateMeasurement.'
      );
    }
    ...
    return this.httpClient.put<WaterMeterMeasurement>(
