...
@Component({
    selector: 'app-page-resident-create',
    templateUrl: './create.component.html',
    styleUrls: ['./create.component.scss'],
})
export class CreateComponent extends CreateAddress {
    public residentForm: FormGroup | undefined;
    ...
    public exit() {
        this.router.navigate(['/manager/home/residents']);
    }
    ...
    private onSave() {
        ...
        return this.svcDwelling.createDwelling(resident);
    }
}
