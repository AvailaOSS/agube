...
@Component({
  ...
  templateUrl: './water-meter-content.component.html',
  styleUrls: ['./water-meter-content.component.scss'],
})
export class WaterMeterContentComponent implements OnInit, OnChanges {
