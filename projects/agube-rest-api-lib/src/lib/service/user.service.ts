...
import { UserDetailConfigure } from '../model/userDetailConfigure';
...
export class UserService {
  ...
  public getConfig(
    ...
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<UserDetailConfigure>;
  public getConfig(
    id: string,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<UserDetailConfigure>>;
  public getConfig(
    id: string,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<UserDetailConfigure>>;
  public getConfig(
    id: string,
    observe: any = 'body',
    reportProgress: boolean = false
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getUserDetailConfig.'
      );
    }
    ...
    return this.httpClient.get<UserDetailConfigure>(
  ...
  public updateConfig(
    id: string,
    data: UserDetailConfigure,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<UserDetailConfigure>>;
  public updateConfig(
    id: string,
    data: UserDetailConfigure,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<UserDetailConfigure>>>;
  public updateConfig(
    id: string,
    data: UserDetailConfigure,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<UserDetailConfigure>>>;
  public updateConfig(
    id: string,
    data: UserDetailConfigure,
    observe: any = 'body',
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling updateConfigureTheme.'
      );
    }

    if (data === null || data === undefined) {
      throw new Error(
        'Required parameter data was null or undefined when calling updateConfigureTheme.'
      );
    }
    ...
    return this.httpClient.put<Array<UserDetailConfigure>>(
      `${this.basePath}/user/${encodeURIComponent(String(id))}/config/`,
      data,
      {
        withCredentials: this.configuration.withCredentials,
 ...
 /**
  ...
  public updateUserDetail(id: string, data: UserDetail, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
      ...
      if (data === null || data === undefined) {
          throw new Error('Required parameter data was null or undefined when calling updateUserDetail.');
      }
      ...
      return this.httpClient.put<Array<UserDetail>>(`${this.basePath}/user/${encodeURIComponent(String(id))}/`,
          data,
          {
              withCredentials: this.configuration.withCredentials,
              headers: headers,
