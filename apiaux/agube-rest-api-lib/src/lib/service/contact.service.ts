...
export class ContactService {
  protected basePath = 'http://localhost:8000/api/v1/contact-book';
  ...
  public contactAddTagsCreate(
    ...
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Tags>>;
  public contactAddTagsCreate(
    contactId: string,
    data: Tags,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Tags>>;
  public contactAddTagsCreate(
    contactId: string,
    data: Tags,
    observe: any = 'body',
    ...
    if (contactId === null || contactId === undefined) {
      throw new Error(
        'Required parameter contactId was null or undefined when calling contactAddTagsCreate.'
      );
    }

    if (data === null || data === undefined) {
      throw new Error(
        'Required parameter data was null or undefined when calling contactAddTagsCreate.'
      );
    }
  ...
  public contactCreate(
    ...
    if (data === null || data === undefined) {
      throw new Error(
        'Required parameter data was null or undefined when calling contactCreate.'
      );
    }
  ...
  public contactTagsList(
    ...
    if (contactId === null || contactId === undefined) {
      throw new Error(
        'Required parameter contactId was null or undefined when calling contactTagsList.'
      );
    }
    ...
    return this.httpClient.get<Array<Tag>>(
      `${this.basePath}/contact/${encodeURIComponent(String(contactId))}/tags`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
